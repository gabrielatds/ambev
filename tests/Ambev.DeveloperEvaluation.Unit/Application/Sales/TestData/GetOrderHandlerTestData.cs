...
/// </summary>
public static class GetOrderHandlerTestData
{
    /// <summary>
    ...
    /// - Items (random array for CreateOrderItemCommand)
    /// </summary>
    private static readonly Faker<GetOrderCommand> createOrderHandlerFaker = new Faker<GetOrderCommand>()
        ...
        .RuleFor(order => order.Items, f => createOrderItemFaker.Generate(f.Random.Int(1, 5)));
    ...
    /// </summary>
    private static readonly Faker<CreateOrderItemCommand> createOrderItemFaker = new Faker<CreateOrderItemCommand>()
